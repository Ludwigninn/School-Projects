...
public class GUIMutex {
	...
	/**
	 * Controlls all actions from listeners.
	 */
	public void ActionHandler() {
		bSync.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				lblStatus.setText("Synced");
				pnlRes.setBackground(Color.GREEN);
			}
		});

		bAsync.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				controller.setMode(false);
				lblStatus.setText("Asynced");
				pnlRes.setBackground(Color.RED);
			}
		});
		...
		btnRun.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				controller.setText(txtTrans.getText());
				controller.initalizeThreads();
			}
		});
	}

	/**
	 * Sets the text from the writer.
	 * @param text
	 */
	public void setListW(char text) {

		listW.append(String.valueOf(text) + "\n");
		
			lblTrans.setText(transTxt += String.valueOf(text));
	
	}

	/**
	 * Sets the text from the reaader.
	 * @param text
	 */
	public void setListR(char text) {
		listR.append(String.valueOf(text) + "\n");
		lblRec.setText(recvTxt += String.valueOf(text));
