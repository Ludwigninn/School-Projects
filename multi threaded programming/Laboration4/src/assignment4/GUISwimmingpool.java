...
public class GUISwimmingpool 
{
	...
	{
		// Create the ReceptionThread panel
		JPanel pnlRec = new JPanel();
		pnlRec.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"ReceptionThread"));
		...
		public void actionPerformed(ActionEvent e) {
			if(checkbool==true){
				controller.setLoopCond(false);
				btnOpen.setText("Closed");
	...
	public void setLblWadv(int lblWadv) {
		this.lblWadv.setText(""+lblWadv);
	}

	public void setLblWcom(int lblWcom) {
		this.lblWcom.setText(""+lblWcom);
	}

	public void setLblAdvLim(int lblAdvLim) {
		this.lblAdvLim.setText("" + lblAdvLim);

	}

	public void setLblComLim(int lblComLim) {
		this.lblComLim.setText(""+lblComLim);
	}


	public void setLblAdvNr(int lblAdvNr) {
		this.lblAdvNr.setText(""+lblAdvNr);
	}

	public void setLblComNr(int lblComNr) {
		this.lblComNr.setText(""+lblComNr);
	}


	public void setLblAexit(int lblAexit) {
		this.lblAexit.setText(""+lblAexit);
	}

	public void setLblCexit(int lblCexit) {
		this.lblCexit.setText(""+lblCexit);
	}
}
